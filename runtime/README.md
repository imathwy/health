...
Deleting `runtime/` does not delete the canonical personal profile, retained
food-related photo exports, media-cleanup audit, medical documents, supplement
records, or canonical `analysis.json` files. Recreate the profile with `diet profile`; recreate one day's
